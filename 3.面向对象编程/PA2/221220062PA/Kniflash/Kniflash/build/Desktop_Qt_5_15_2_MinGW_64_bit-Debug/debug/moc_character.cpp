...
QT_MOC_LITERAL(1, 10, 4), // "died"
QT_MOC_LITERAL(2, 15, 0), // ""
QT_MOC_LITERAL(3, 16, 10), // "Character*"
QT_MOC_LITERAL(4, 27, 9), // "character"
QT_MOC_LITERAL(5, 37, 13), // "healthChanged"
QT_MOC_LITERAL(6, 51, 9), // "newHealth"
QT_MOC_LITERAL(7, 61, 13), // "knivesChanged"
QT_MOC_LITERAL(8, 75, 9) // "newKnives"

    },
    "Character\0died\0\0Character*\0character\0"
    "healthChanged\0newHealth\0knivesChanged\0"
    "newKnives"
};
...
void Character::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->died((*reinterpret_cast< Character*(*)>(_a[1]))); break;
        case 1: _t->healthChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->knivesChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (Character::*)(Character * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Character::died)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Character::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Character::healthChanged)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Character::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Character::knivesChanged)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void Character::died(Character * _t1)
{
...
// SIGNAL 2
void Character::knivesChanged(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
